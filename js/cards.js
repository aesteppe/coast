  ...
  S.routes.forEach((r, i) => {
    ...
    if (r.m){
      ...
      html +=
        ...
        '</div>';
      if (r.prof && r.prof.suspect){
        html += '<div class="noel">Terrain samples here show grades no road sustains, ' +
          'often a bridge or canyon artifact. Treat the energy figures as rough.</div>';
      }
    } else {
