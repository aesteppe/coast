...
/* Mutated in place on every render; the segment callback below reads it live,
   so the chart can be updated rather than destroyed and rebuilt. */
const segColors = [];
...
export function renderChart(){
  ...
  /* Update in place when the chart already exists. Selection changes and
     vehicle-slider drags land here constantly; a rebuild per event is the
     kind of churn that makes sliders feel broken on slower machines. */
  if (chart){
